...
export default function StudentLogin() {
    ...
    return (
        <div className="min-h-screen flex" style={{ fontFamily: "'Inter', sans-serif" }}>
            {/* Left branding panel */}
            <div className="hidden lg:flex lg:w-2/5 flex-col items-center justify-center p-12 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #064e3b 0%, #065f46 50%, #059669 100%)' }}>
                ...
                <div className="absolute w-48 h-48 rounded-full opacity-10" style={{ background: 'radial-gradient(circle, #6ee7b7, transparent)', bottom: '50px', right: '-30px' }} />
                ...
                <div className="relative z-10 text-center">
                    ...
                    <div className="px-4 py-3 rounded-2xl" style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.15)' }}>
                        <p className="text-white font-bold text-lg">Student Portal</p>
                        <p className="text-sm mt-1" style={{ color: 'rgba(255,255,255,0.6)' }}>Access courses, practice & exams</p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-6 bg-gray-50">
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                        <div className="mb-8">
                            <span className="text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full" style={{ background: '#059669', color: 'white' }}>Student</span>
                            <h1 className="text-2xl font-extrabold text-gray-900 mt-3">Welcome back</h1>
                            <p className="text-gray-500 text-sm mt-1">Sign in to access your typing courses</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    disabled={loading}
                                    className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition disabled:bg-gray-50"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        required
                                        disabled={loading}
                                        className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition disabled:bg-gray-50 pr-12"
                                        placeholder="••••••••"
                                    />
                        ...
                        <p className="mt-4 text-center text-xs text-gray-400">Contact your institute if you cannot log in.</p>
                    </div>
                </div>
            </div>
        </div>
